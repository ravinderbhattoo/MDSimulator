...
interatomic_potentials = [NN(model), LennardJonesParameters(0ϵ, σpot, R)]

Sim = MDSim(u0, v0, mass, interatomic_potentials, boundary_condition; Δτ = Δτ, save_every = 10, global_save_every = 10, max_neighs_hard_set=150, reneighboring_every=Inf, check_units=false)
